...
class SettingsTableMap extends TableMap
{
     ...
     */
    const COL_VALOR_INSCRICAO = 'settings.valor_inscricao';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SettingsTableMap::COL_ID, SettingsTableMap::COL_VALOR_INSCRICAO, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SettingsTableMap::COL_ID => 0, SettingsTableMap::COL_VALOR_INSCRICAO => 1, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SettingsTableMap::COL_VALOR_INSCRICAO);
        } else {
