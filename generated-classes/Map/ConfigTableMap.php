...
class ConfigTableMap extends TableMap
{
     ...
     */
    const COL_VALOR_INSCRICAO = 'config.valor_inscricao';

    /**
     * the column name for the status field
     */
    const COL_STATUS = 'config.status';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ValorInscricao', 'Status', ),
        self::TYPE_CAMELNAME     => array('id', 'valorInscricao', 'status', ),
        self::TYPE_COLNAME       => array(ConfigTableMap::COL_ID, ConfigTableMap::COL_VALOR_INSCRICAO, ConfigTableMap::COL_STATUS, ),
        self::TYPE_FIELDNAME     => array('id', 'valor_inscricao', 'status', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ValorInscricao' => 1, 'Status' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'valorInscricao' => 1, 'status' => 2, ),
        self::TYPE_COLNAME       => array(ConfigTableMap::COL_ID => 0, ConfigTableMap::COL_VALOR_INSCRICAO => 1, ConfigTableMap::COL_STATUS => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'valor_inscricao' => 1, 'status' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setPrimaryKeyMethodInfo('config_id_seq');
        // columns
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ConfigTableMap::COL_VALOR_INSCRICAO);
            $criteria->addSelectColumn(ConfigTableMap::COL_STATUS);
        } else {
