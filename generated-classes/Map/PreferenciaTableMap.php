...
/**
 * This class defines the structure of the 'preferencia' table.
 *
 *
 *
...
class PreferenciaTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'preferencia.id';

    /**
     * the column name for the descricao field
     */
    const COL_DESCRICAO = 'preferencia.descricao';
    ...
    {
        // attributes
        $this->setName('preferencia');
        $this->setPhpName('Preferencia');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\Preferencia');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('preferencia_id_seq');
        // columns
    ...
    /**
     * Deletes all rows from the preferencia table.
     *
     * @param ConnectionInterface $con the connection to use
