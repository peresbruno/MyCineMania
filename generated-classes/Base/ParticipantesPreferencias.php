...
/**
 * Base class that represents a row from the 'participantes_preferencias' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class ParticipantesPreferencias implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ParticipantesPreferenciasTableMap';
    ...
    /**
     * Initializes internal state of Base\ParticipantesPreferencias object.
     */
    ...
    /**
     * Compares this with another <code>ParticipantesPreferencias</code> instance.  If
     * <code>obj</code> is an instance of <code>ParticipantesPreferencias</code>, delegates to
     * <code>equals(ParticipantesPreferencias)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ParticipantesPreferencias The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = ParticipantesPreferenciasTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ParticipantesPreferencias'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildParticipantesPreferenciasQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ParticipantesPreferencias::setDeleted()
     * @see ParticipantesPreferencias::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildParticipantesPreferenciasQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ParticipantesPreferenciasTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO participantes_preferencias (%s) VALUES (%s)',
    ...
    {
        $pos = ParticipantesPreferenciasTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ParticipantesPreferencias'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ParticipantesPreferencias
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ParticipantesPreferencias (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ParticipantesPreferencias Clone of current object.
     * @throws PropelException
     */
    ...
    public function getParticipante(ConnectionInterface $con = null)
    {
        if ($this->aParticipante === null && ($this->participante_id !== null)) {
            $this->aParticipante = ChildParticipanteQuery::create()
                ->filterByParticipantesPreferencias($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aParticipante->addParticipantesPreferenciass($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ParticipantesPreferenciasTableMap::DEFAULT_STRING_FORMAT);
    }
