...
/**
 * Base class that represents a row from the 'beneficios_preferencias' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class BeneficiosPreferencias implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BeneficiosPreferenciasTableMap';
    ...
    /**
     * Initializes internal state of Base\BeneficiosPreferencias object.
     */
    ...
    /**
     * Compares this with another <code>BeneficiosPreferencias</code> instance.  If
     * <code>obj</code> is an instance of <code>BeneficiosPreferencias</code>, delegates to
     * <code>equals(BeneficiosPreferencias)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|BeneficiosPreferencias The current object, for fluid interface
     */
     ...
     * @return $this|\BeneficiosPreferencias The current object (for fluent API support)
     */
    public function setPreferenciaId($v)
    {
        ...
        if ($this->preferencia_id !== $v) {
            ...
            $this->modifiedColumns[BeneficiosPreferenciasTableMap::COL_PREFERENCIA_ID] = true;
        }
    ...
    public function setBeneficioId($v)
    {
        ...
        if ($this->beneficio_id !== $v) {
            $this->beneficio_id = $v;
            $this->modifiedColumns[BeneficiosPreferenciasTableMap::COL_BENEFICIO_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BeneficiosPreferenciasTableMap::translateFieldName('PreferenciaId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->preferencia_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BeneficiosPreferenciasTableMap::translateFieldName('BeneficioId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = BeneficiosPreferenciasTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\BeneficiosPreferencias'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBeneficiosPreferenciasQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see BeneficiosPreferencias::setDeleted()
     * @see BeneficiosPreferencias::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBeneficiosPreferenciasQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BeneficiosPreferenciasTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BeneficiosPreferenciasTableMap::COL_PREFERENCIA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'preferencia_id';
        }
        if ($this->isColumnModified(BeneficiosPreferenciasTableMap::COL_BENEFICIO_ID)) {
            $modifiedColumns[':p' . $index++]  = 'beneficio_id';
        }

        $sql = sprintf(
            'INSERT INTO beneficios_preferencias (%s) VALUES (%s)',
    ...
    {
        $pos = BeneficiosPreferenciasTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['BeneficiosPreferencias'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BeneficiosPreferencias'][$this->hashCode()] = true;
        $keys = BeneficiosPreferenciasTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\BeneficiosPreferencias
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BeneficiosPreferenciasTableMap::COL_PREFERENCIA_ID)) {
            $criteria->add(BeneficiosPreferenciasTableMap::COL_PREFERENCIA_ID, $this->preferencia_id);
        }
        if ($this->isColumnModified(BeneficiosPreferenciasTableMap::COL_BENEFICIO_ID)) {
            $criteria->add(BeneficiosPreferenciasTableMap::COL_BENEFICIO_ID, $this->beneficio_id);
        }
    ...
    {
        $criteria = ChildBeneficiosPreferenciasQuery::create();
        $criteria->add(BeneficiosPreferenciasTableMap::COL_PREFERENCIA_ID, $this->preferencia_id);
        $criteria->add(BeneficiosPreferenciasTableMap::COL_BENEFICIO_ID, $this->beneficio_id);
    ...
    public function hashCode()
    {
        ...
        //relation beneficios_preferencias_fk_4019bf to table preferencias
        ...
        //relation beneficios_preferencias_fk_9665b2 to table beneficios
    ...
    {
        return (null === $this->getPreferenciaId()) && (null === $this->getBeneficioId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \BeneficiosPreferencias (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \BeneficiosPreferencias Clone of current object.
     * @throws PropelException
     */
    ...
    public function setPreferencia(ChildPreferencia $v = null)
    {
        ...
        if ($v !== null) {
            $v->addBeneficiosPreferencias($this);
        }
    ...
    public function getPreferencia(ConnectionInterface $con = null)
    {
        if ($this->aPreferencia === null && ($this->preferencia_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPreferencia->addBeneficiosPreferenciass($this);
             */
        }
    ...
    public function getBeneficio(ConnectionInterface $con = null)
    {
        if ($this->aBeneficio === null && ($this->beneficio_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBeneficio->addBeneficiosPreferenciass($this);
             */
        }
    ...
    {
        if (null !== $this->aPreferencia) {
            $this->aPreferencia->removeBeneficiosPreferencias($this);
        }
        if (null !== $this->aBeneficio) {
            $this->aBeneficio->removeBeneficiosPreferencias($this);
        }
    ...
    {
        return (string) $this->exportTo(BeneficiosPreferenciasTableMap::DEFAULT_STRING_FORMAT);
    }
