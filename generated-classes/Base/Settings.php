...
abstract class Settings implements ActiveRecordInterface
{
    ...
    /**
     * The value for the valor_inscricao field.
     * @var        double
     */
    protected $valor_inscricao;
    ...
    /**
     * Get the [valor_inscricao] column value.
     *
     * @return double
     */
    ...
    /**
     * Set the value of [valor_inscricao] column.
     *
     * @param double $v new value
     * @return $this|\Settings The current object (for fluent API support)
     */
    public function setValorInscricao($v)
    {
        if ($v !== null) {
            $v = (double) $v;
        }

        if ($this->valor_inscricao !== $v) {
            $this->valor_inscricao = $v;
            $this->modifiedColumns[SettingsTableMap::COL_VALOR_INSCRICAO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SettingsTableMap::translateFieldName('ValorInscricao', TableMap::TYPE_PHPNAME, $indexType)];
            $this->valor_inscricao = (null !== $col) ? (double) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('settings_id_seq')");
        ...
        if ($this->isColumnModified(SettingsTableMap::COL_VALOR_INSCRICAO)) {
            $modifiedColumns[':p' . $index++]  = 'valor_inscricao';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'valor_inscricao':
                        $stmt->bindValue($identifier, $this->valor_inscricao, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setValorInscricao($arr[$keys[1]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SettingsTableMap::COL_VALOR_INSCRICAO)) {
            $criteria->add(SettingsTableMap::COL_VALOR_INSCRICAO, $this->valor_inscricao);
        }
    ...
    {
        $copyObj->setValorInscricao($this->getValorInscricao());
        if ($makeNew) {
            $copyObj->setNew(true);
